...
struct Filter<Pred, tuple<Head, Ts...>> {
  typedef
      typename Tuple_PushFront<Head, Pred::template Apply<Head>::value,
...
struct ConcatenateTuple<FirstTuple, Follows...> {
  typedef typename ConcatenateTuple<
      FirstTuple, typename ConcatenateTuple<Follows...>::type>::type type;
};
...
struct QuickSort<tuple<Head, Ts...>> {
  ...
  typedef typename ConcatenateTuple<
      typename QuickSort<LeftElems>::type, tuple<Head>,
