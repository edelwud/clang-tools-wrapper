...
struct Filter<Pred, tuple<Head, Ts...>> {
    typedef typename Tuple_PushFront<
        Head, Pred::template Apply<Head>::value, typename Filter<Pred, tuple<Ts...>>::type>::type type;
};
...
struct QuickSort<tuple<Head, Ts...>> {
    ...
    typedef typename ConcatenateTuple<
        typename QuickSort<LeftElems>::type, tuple<Head>, typename QuickSort<RightElems>::type>::type type;
};
